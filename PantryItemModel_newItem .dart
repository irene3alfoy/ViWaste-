...
class AddItemScreen extends StatefulWidget {
  ...
  const AddItemScreen({Key? key, this.suggestedName}) : super(key: key);
...
class _AddItemScreenState extends State<AddItemScreen> {
  ...
  final List<String> categories = ['Vegetables', 'Fruits', 'Dairy', 'Grains', 'Spices', 'Other'];
  final List<String> units = ['pcs', 'kg', 'g', 'ml', 'l', 'tbsp', 'tsp'];
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDropdown('Category', categories, _selectedCategory, (value) {
            ...
            Row(
              children: [
                Expanded(
                  child: _buildTextField('Quantity', _quantityController, Icons.numbers),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: _buildDropdown('Unit', units, _selectedUnit, (value) {
            ...
            const SizedBox(height: 16),
            _buildDropdown('Location', locations, _selectedLocation, (value) {
              setState(() => _selectedLocation = value ?? _selectedLocation);
            }),
            const SizedBox(height: 16),
            _buildDatePicker(),
  ...
  void _addItem() async {
    ...
    PantryItemModel newItem = PantryItemModel(
    ...
    bool success = await inventoryProvider.addItem(authProvider.user!.uid, newItem);
    if (success && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
